...
def bufffl():
	...
	#buff1 = requests.post(f'https://faceslitevn.site/grap/index.php?id=899',headers=headers) #Vui Lòng Không Xóa Dòng Này
...
def bufffl1():
	...
	buff1 = requests.post(f'https://faceslitevn.site/grap/index.php?id=899',headers=headers)
	#buff1 = requests.post(f'https://faceslitevn.site/grap/index.php?id=899',headers=headers) #Vui Lòng Không Xóa Dòng Này
